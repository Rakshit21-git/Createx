      ...
      <div className="your_look container">
        <div className="row">
          <div className="col-12">
              ...
              <div className="col-md-5 col-12 your_look_first">
                 <h1 className="mb-lg-3  your_look_header">Complete Your Look</h1>             
                <img className="your_look_img" src="Assests/Images/Your Look/1.png" alt="" />
              </div>
              <div className="col-1"></div>
              <div className="col-lg-6 col-md-4 col-12 jk">
                <Carousel
                  showDots={true}
