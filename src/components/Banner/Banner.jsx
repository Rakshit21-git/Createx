        ...
        <>
            <div className="container-fluid ">
                <div className="row mt-5">
                    <div className="col-4 first me-3">
                        <div className="row">
                            <div className="col-12  ms-4 mt-5 ">SUMMER COLLECTION</div>
                            <div className="col-12 fw-bold  ms-4 fs-3 ">Sale Up to 70%</div>
                        </div>
                    ...
                    <div className="col-7 second">
                        <div className="row">
                            <div className="col-12 mt-5 ms-4">
                                DEAL OF THE WEEK
                            </div>
                        </div>
                        <div className="row">
                ...
                <div className="row mt-3 mb-5">
                    <div className="col-7 third me-3">
                        <div className="row">
                            <div className="col-12 mt-5 ms-4">
                                NEW COLLECTON
                            </div>
                    ...
                    <div className="col-4 four">
                        ...
                        <div className="row">
                            ...
                            <div className="col-12 fw-bold ms-4 fs-3" >
                                Get 5% Off & Free Delivaery
                            </div>
                            <div className="col-12 ms-4 mt-4">Email</div>
                        </div>
