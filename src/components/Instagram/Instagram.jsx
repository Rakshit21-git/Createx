            ...
            <div className="container mt-5 Insta">
                <div className="row">
                    <div className="col-sm-12 col-lg-4">
                        <div className="row">
                            <div className="col-12 ClassFirst FlexClass">
                                FOLLOW US ON INSTAGRAM
                            </div>
                            <div className="col-12 fw-bold fs-3 ClassSecond FlexClass">
                                @createx_store
                            </div>
                            <div className="col-8 mt-5 ClassThird" style={{ border: "1px solid #17696A" }}>
